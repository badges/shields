...
const config = {
  ...
  themeConfig: {
    ...
    footer: {
      // Remove style: 'dark' to allow theme switching
      links: [
        {
          title: 'Community',
          items: [
            { label: 'GitHub', href: 'https://github.com/badges/shields' },
            {
              label: 'Open Collective',
              href: 'https://opencollective.com/shields',
            },
            { label: 'Discord', href: 'https://discord.gg/HjJCwm5' },
            {
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Metrics dashboard', href: 'https://metrics.shields.io/' },
          ],
        },
        {
          title: 'Policy',
