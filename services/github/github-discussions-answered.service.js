...
export default class GithubAnsweredDiscussions extends GithubAuthV4Service {
  static category = 'other'
  static route = {
    base: 'github/discussions-answered',
    pattern: ':user/:repo',
  }
  ...
  static defaultBadgeData = { label: 'discussions', color: 'brightgreen' }
  ...
  async handle({ user, repo }) {
    ...
    return this.constructor.render({ discussions: `${totalCount} answered` })
  }
}
