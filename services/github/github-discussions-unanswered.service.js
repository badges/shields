...
export default class GithubUnansweredDiscussions extends GithubAuthV4Service {
  static category = 'other'
  static route = {
    base: 'github/discussions-unanswered',
    pattern: ':user/:repo',
  }
  ...
  static defaultBadgeData = { label: 'discussions', color: 'orange' }
  ...
  async handle({ user, repo }) {
    ...
    return this.constructor.render({ discussions: `${totalCount} unanswered` })
  }
}
