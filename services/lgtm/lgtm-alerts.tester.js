...
t.create('alerts: no alerts')
  ...
  .expectBadge({ label: 'alerts', message: '0' })
...
t.create('alerts: single alert')
  ...
  .expectBadge({ label: 'alerts', message: '1' })
...
t.create('alerts: multiple alerts')
  ...
  .expectBadge({ label: 'alerts', message: '123' })
...
t.create('alerts: json missing alerts')
  ...
  .expectBadge({ label: 'alerts', message: 'invalid response data' })
