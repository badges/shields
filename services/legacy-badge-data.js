...
const logos = require('../core/legacy/load-logos')()
const simpleIcons = require('../core/legacy/load-simple-icons')()
const { svg2base64, isDataUri } = require('../core/legacy/logo-helper')
