...
const { makeBadgeData } = require('../../services/legacy-badge-data')
const { Inaccessible } = require('../base-service')
const { setCacheHeaders } = require('../base-service/cache-headers')
...
function handleRequest(cacheHeaderConfig, handlerOptions) {
  ...
  return (queryParams, match, end, ask) => {
    ...
    const serverResponsive = setTimeout(() => {
      ...
      const badgeData = makeBadgeData('vendor', filteredQueryParams)
