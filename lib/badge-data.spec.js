...
describe('Badge data helpers', function() {
  ...
  test(setBadgeColor, () => {
    ...
    given({ colorB: '#f00f00', colorscheme: 'blue' }, 'red').expect({ colorB: '#f00f00', colorscheme: 'red' });
    given({ colorB: '#b00b00', colorscheme: 'blue' }, 'f00f00').expect({ colorB: '#f00f00', colorscheme: 'blue' });
  });
});
