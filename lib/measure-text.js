...
const defaultMeasurer = new QuickTextMeasurer('Verdana.ttf');
//whenReady.then(() => defaultMeasurer.prepare());

module.exports = {
  PDFKitTextMeasurer,
  QuickTextMeasurer,
  measure: defaultMeasurer.widthOf.bind(defaultMeasurer),
};
