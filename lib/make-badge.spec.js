...
describe('The badge generator', function () {
  ...
  describe('css color regex', function () {
    it('should check if given valid hex color', function () {
      const colorsTrue = ["#4c1","#4C1","#abc123","#ABC123","rgb(0,123,255)","rgba(0,123,255,0.5)","rgba(0,123,255,0.55)","rgba(0,123,255,0)","rgba(0,123,255,1)","red","papayawhip","purple","blue","notarealcolor"];
      const colorsFalse = ["no","#123red","#red","rgba(0,123,255,1.1)"];
