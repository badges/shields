...
const defaultColor = definedColorschemes.default;
...
function makeBadge (measurer, {
  ...
  colorA = definedColorschemes[colorA] !== undefined ? definedColorschemes[colorA].colorA || defaultColor.colorA : validColor(colorA) ? colorA : defaultColor.colorA;
  colorB = definedColorschemes[colorB] !== undefined ? definedColorschemes[colorB].colorB || defaultColor.colorB : validColor(colorB) ? colorB : defaultColor.colorB;
