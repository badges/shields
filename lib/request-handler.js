...
const { coalesceCacheLength, setCacheHeaders } = require('../services/caching')
...
function handleRequest(cacheConfig, handlerOptions) {
  ...
  const { cacheLength: handlerCacheLength } = handlerOptions
  ...
  return (queryParams, match, end, ask) => {
    ...
    setCacheHeaders(ask.res, cacheLengthSeconds)
