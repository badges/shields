...
function handleRequest(cacheHeaderConfig, handlerOptions) {
  ...
  return (queryParams, match, end, ask) => {
    ...
    // We set cache headers once here in case one of our exception handlers
    // handles the response. We set them again once we have real data from the
    // service.
    ...
    vendorDomain.run(() => {
      const result = handlerOptions.handler(
        ...
        function sendBadge(format, badgeData, serviceCacheLengthSeconds) {
