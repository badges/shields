...
function makeLogo(defaultNamedLogo, overrides) {
  if (overrides.logo === undefined){
    return getSimpleIcon(defaultNamedLogo, overrides.logoColor) || logos[defaultNamedLogo];
  }
  ...
  if (isDataUri(maybeDataUri)) {
    ...
    return getSimpleIcon(overrides.logo, overrides.logoColor) || logos[overrides.logo];
  }
}
