...
const allBadgeExamples = [
  ...
  },
  {
    ...
    examples: [
      ...
      {
        title: 'iTunes App Store version',
        previewUri: '/itunes/v/803453959.svg',
        exampleUri: '/itunes/v/APPLE_ID.svg'
      },
      {
        title: 'iTunes App Store version (international)',
        previewUri: '/itunes/v/fr/484006842.svg',
        exampleUri: '/itunes/v/COUNTRY/APPLE_ID.svg'
      },
      {
        title: 'iTunes App Store ratings',
        previewUri: '/itunes/r/803453959.svg',
        exampleUri: '/itunes/r/APPLE_ID.svg'
      },
      {
        title: 'iTunes App Store ratings (international)',
        previewUri: '/itunes/r/fr/484006842.svg',
        exampleUri: '/itunes/r/COUNTRY/APPLE_ID.svg'
      },
      {
        title: 'iTunes App Store minimum iOS version',
        previewUri: '/itunes/m/803453959.svg',
        exampleUri: '/itunes/m/APPLE_ID.svg'
      },
      {
        title: 'iTunes App Store minimum iOS version (international)',
        previewUri: '/itunes/m/fr/484006842.svg',
        exampleUri: '/itunes/m/COUNTRY/APPLE_ID.svg'
      },
      {
        title: 'JitPack',
