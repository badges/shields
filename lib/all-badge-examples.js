...
const allBadgeExamples = [
  {
    ...
    examples: [
      {
        title: 'Distelli build',
        previewUri: '/distelli/build/ORG/APPLICATION-NAME.svg?token=TOKEN',
        exampleUri: '/distelli/build/ORG/APPLICATION-NAME.svg?token=TOKEN'
      },
      {
        title: 'Distelli deploy',
        previewUri: '/distelli/deploy/ORG/APPLICATION-NAME.svg?token=TOKEN',
        exampleUri: '/distelli/deploy/ORG/APPLICATION-NAME.svg?token=TOKEN'
      },
      {
        title: 'Travis',
      ...
      },
      {
        ...
        exampleUri: '/appveyor/tests/NZSmartie/coap-net-iu0to.svg'
      },
      {
        title: 'Codeship',
      ...
      },
      {
        ...
        previewUri: '/coveralls/bitbucket/pyKLIP/pyklip.svg',
        exampleUri: '/coveralls/bitbucket/pyKLIP/pyklip/master.svg'
      },
      {
  ...
  },
  {
    ...
    examples: [
      ...
      },
      {
        ...
        documentation: githubDoc,
        exampleUri: '/github/issues-pr-closed/cdnjs/cdnjs.svg',
      },
      {
      ...
      },
      {
        ...
        documentation: githubDoc,
        exampleUri: '/github/commits/google/skia/last.svg',
      },
      {
        ...
        documentation: githubDoc,
        exampleUri: '/github/commits/google/skia/infra/config/last.svg'
      },
      {
