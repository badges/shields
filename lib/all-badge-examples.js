...
const allBadgeExamples = [
  {
    ...
    examples: [
      ...
      },
      {
        ...
        previewUri: '/codecov/c/github/codecov/example-python.svg',
        placeholderUri:
          '/codecov/c/token/:token/github/codecov/example-python.svg',
        exampleUri: '/codecov/c/github/codecov/example-python.svg',
      },
      {
        title: 'Coverity Scan',
      ...
      },
      {
        ...
        placeholderUri: '/dockbit/:organisation/:pipeline.svg?token=:token',
        exampleUri:
          '/dockbit/DockbitStatus/health.svg?token=TvavttxFHJ4qhnKstDxrvBXM',
      },
      {
  ...
  },
  {
    ...
    examples: [
      ...
      },
      {
        ...
        placeholderUri: '/itunes/v/:bundle-id.svg',
