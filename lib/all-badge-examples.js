...
<p>
  ...
  <br>
  There is also a <code>&compactValue</code> query parameter, when present, will default to displaying ✔, ✘ and ● (without comma separators).
  <br>
...
const allBadgeExamples = [
  {
    ...
    examples: [
      ...
      {
        title: 'AppVeyor tests with compact value',
